...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='TrajGPT for pretraining PopHR irregularly-sampled time series')
    ...
    parser.add_argument('--model', type=str, default='TrajGPT', help='model name, options: [TrajGPT]')
    ...
    parser.add_argument('--tau', type=int, default=20, help='temperature for data-dependent dacay')
    parser.add_argument('--ffn_proj_size', type=int, default=800, help='dimension for feed-forward projection layer')
    parser.add_argument('--forward_impl', type=str, default='parallel',
                        help='forward implementation, options:[parallel, recurrent]')
    parser.add_argument('--use_bias_in_sra', type=bool, default=False, help='Use bias in SRA')
    parser.add_argument('--use_bias_in_mlp', type=bool, default=True, help='Use bias in feed-forward layer')
    parser.add_argument('--use_bias_in_sra_out', type=bool, default=False, help='Use bias in SRA output layer')
    ...
    model = TrajGPT(configs=args).to(device=device)
